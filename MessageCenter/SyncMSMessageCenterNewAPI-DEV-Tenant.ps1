...
##Declare Variables
$AppClientID = "ff32c7d9-9648-430e-b425-efc875ce73cc" # "0f6a6412-8f62-4b7a-a929-664174baf961"
$AppTenantID = "c684c0c2-23d6-4d84-ba9d-306a5b0522d8" #"14b77578-9773-42d5-8507-251ca2dc2b06"
$AppClientSecret = ConvertTo-SecureString "mNY7Q~krUjRyClNINv2FREmyZnvCB-qxgMmXx" -AsPlainText -Force
$AppCertificatePath =  "cert:\LocalMachine\my\7BA7CBA81EDC57BF8446C549294148FB8490AD5B"#"cert:\LocalMachine\my\D0CE39CFCDBE72E92A3233A4C3BB891DC6045431"
##Import Certificate
...
function Get-AccessToken()
{
    ...
    try {
        $oauth = Get-MsalToken -ClientId $AppClientID -TenantId $AppTenantID  -ClientCertificate $AppCertificate -Verbose #-ClientSecret $AppClientSecret -Verbose #Invoke-RestMethod -Method Post -Uri $loginURL/$tenantDomain/oauth2/token?api-version=1.0 -Body $body
    }
    catch {        
...
{    
    ...
    $mcListId = "6EA71BCF-2798-4449-936B-3EA84E5C7473"
    ...
    $siteContext = Connect-PnPOnline -Url $SPORootSiteURL -ReturnConnection -verbose -ClientId $AppId  -Thumbprint $Thumbprint -Tenant $TenantName #-ClientSecret $spAppSecret  #
    ...
    {   
        ...
        {  
	        ...
	        $text += "<tr><td>Action Required By</td><td>$($NewListItem.ActionBy)</td></tr>"	            
    ...
    $subject = "[MC-CITSPDEV] Daily Updates"
    $toAddress = "CITM365CollabTenantAdmins@mail.nih.gov"
